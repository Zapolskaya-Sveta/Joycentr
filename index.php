...
// Загрузка статей
$stmt = $pdo->query("SELECT * FROM posts WHERE status = 'published' OR status IS NULL ORDER BY created_at DESC LIMIT 10");
$articles = $stmt->fetchAll();

// Загрузка специалистов
$stmtSpecs = $pdo->query("SELECT * FROM specialists ORDER BY id ASC");
$specialists = $stmtSpecs->fetchAll();
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12">
                ...
                <p class="section-text">Цель психологического центра J.O.Y Consulting ® - помочь вам раскрыть таланты и исцелить душевные раны, чтобы обрести радость, благодарность и принятие.</p>
...
<section id="section-4" class="section services-section">
    ...
    <div class="services-grid">
        <div class="service-card">
            <div class="service-icon"><img src="img/session.png" alt="Сессия"></div>
        ...
        <div class="service-card">
            <div class="service-icon"><img src="img/meditation.png" alt="Медитации"></div>
            <div class="service-content">
                <h4>Медитации</h4>
        ...
        <div class="service-card">
            <div class="service-icon"><img src="img/club.png" alt="Закрытый клуб"></div>
            <div class="service-content">
    ...
    <div class="container">
        ...
        <div class="timeline-area">
            <div class="row position-relative process-step align-items-center">
                ...
                <div class="col-lg-6 col-img-right mt-4 mt-lg-0"><img src="img/Untitled-21.png" alt="Медитация" class="process-img img-step-1"></div>
            </div>
            ...
            <div class="row position-relative process-step flex-lg-row-reverse align-items-center">
                ...
                <div class="col-lg-6 col-img-left mt-4 mt-lg-0"><img src="img/recommendations.png" alt="Камни" class="process-img img-step-2"></div>
            </div>
            ...
            <div class="row position-relative process-step align-items-center">
                ...
                <div class="col-lg-6 col-img-right mt-4 mt-lg-0"><img src="img/meditation-work.png" alt="Блокнот" class="process-img img-step-3"></div>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 col-sm-6 text-center mb-3">
                <div class="result-circle mx-auto" onclick="flipResult(this)">
                    <div class="front"><img src="img/Frame.png" alt="Иконка результата 1"></div>
                    <div class="back">Осознаете свои истинные желания и потребности</div>
                </div>
                <h3 class="mt-3">Понимаете себя и свои истинные желания</h3>
            </div>
            <div class="col-md-4 col-sm-6 text-center mb-3">
                <div class="result-circle mx-auto" onclick="flipResult(this)">
                    <div class="front"><img src="img/Frame(1).png" alt="Иконка результата 2"></div>
                    <div class="back">Улучшаете коммуникацию и глубину отношений</div>
                </div>
                <h3 class="mt-3">Выводите отношения с родными и близкими на новый уровень</h3>
            </div>
            <div class="col-md-4 col-sm-6 text-center mb-3">
                <div class="result-circle mx-auto" onclick="flipResult(this)">
                    <div class="front"><img src="img/Frame(2) .png" alt="Иконка результата 3"></div>
                    <div class="back">Находите корень проблемы и пути решения</div>
                </div>
                <h3 class="mt-3">Прорабатываете проблемные ситуации раз и навсегда</h3>
            </div>
            <div class="col-md-4 col-sm-6 text-center mb-3">
                <div class="result-circle mx-auto" onclick="flipResult(this)">
                    <div class="front"><img src="img/Frame(4).png" alt="Иконка результата 4"></div>
                    <div class="back">Привлекаете новые финансовые возможности</div>
                </div>
                <h3 class="mt-3">Налаживаете финансовые потоки и становитесь богаче</h3>
            </div>
            <div class="col-md-4 col-sm-6 text-center mb-3">
                <div class="result-circle mx-auto" onclick="flipResult(this)">
                    <div class="front"><img src="img/Frame(3).png" alt="Иконка результата 5"></div>
                    <div class="back">Обретаете внутренний баланс и гармонию</div>
                </div>
                <h3 class="mt-3">Стабилизируете своё внутреннее состояние</h3>
            </div>
            <div class="col-md-4 col-sm-6 text-center mb-3">
                <div class="result-circle mx-auto" onclick="flipResult(this)">
                    <div class="front"><img src="img/Frame(5).png" alt="Иконка результата 6"></div>
                    <div class="back">Открываете в себе скрытые ресурсы и потенциал</div>
                </div>
                <h3 class="mt-3">Чувствуете свою "супер силу", открываете неограниченный источник энергии</h3>
            </div>
        </div>
                        ...
                        <div class="specialists-grid" id="spec-slider">
                            <?php if (count($specialists) > 0): ?>
                                ...
                                <div class="specialist-card">
                                    ...
                                    <div class="specialist-role"><?= htmlspecialchars($spec['specialization']) ?></div>
                                    <button class="main-button small-btn" onclick="location.href='profile.php?id=<?= $spec['id'] ?>'">Подробнее</button>
                                </div>
                                <?php endforeach; ?>
                            <?php else: ?>
...
<!-- СЕКЦИЯ 7 (ВСТРЕЧАЕМСЯ ЗДЕСЬ И СЕЙЧАС) -->
                ...
                <div class="panel-container">
                    <div class="text-panel">
                        <div class="text-content">
                            ...
                            <p>Все очные сессии проходят в центре Минска, в стильном и уютном офисе в 5 минутах от ст.м. Немига. Во дворе есть удобная парковка.</p>
                            <p>Мы создали идеальную атмосферу для того, чтобы вам было максимально комфортно.</p>
                            ...
                            <?php if(count($articles) > 0): ?>
                                <?php foreach ($articles as $article): ?>
                                    <a href="article.php?id=<?= $article['id'] ?>">
                                        <img src="<?= htmlspecialchars($article['image']) ?>" alt="<?= htmlspecialchars($article['title']) ?>" onerror="this.src='img/Frame.png'">
                                    </a>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <p class="empty-slider-msg">Новые публикации появятся в ближайшее время...</p>
                            <?php endif; ?>
                        </div>
                    </div>
...
<section id="section-9" class="section-9">
    ...
    <div class="section-9__content">
        <div class="container">
            <div class="row text-center"><div class="col-12"><h2 class="section-title">НАЧАТЬ — ПРОСТО</h2><h3 class="subsection-title">Начни с бесплатной медитации</h3></div></div>
            <div class="row align-items-center">
                <div class="col-lg-6 section-9__text">
                    <p class="section-text">Если вы не уверены, что готовы начать с полноценной сессии — начните с медитации, которую мы предлагаем прямо сейчас.</p>
                ...
                <div class="col-lg-6 section-9__image"><img src="img/tel.png" alt="Медитация" class="img-fluid"></div>
            </div>
        </div>
    </div>
</section>
...
<section id="section-10" class="section section-10">
    <div class="container">
        <div class="row justify-content-center text-center mb-5"><div class="col-lg-8"><h2 class="section-title">ОСТАЛИСЬ ВОПРОСЫ?</h2><h3 class="subsection-title">Контакты</h3></div></div>
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0"><img src="img/Maskgroup.png" alt="Контакты" class="img-fluid"></div>
            <div class="col-lg-6 contact-right-side contact-block-padding">
                <div class="contact-text">
                    ...
                    <p class="section-text">При необходимости – можно созвониться голосом.</p>
                </div>
                ...
                <div class="telegram-link">
                    ...
                    <div class="d-flex align-items-center"><i class="fab fa-telegram-plane telegram-icon mr-2"></i><a href="#" class="telegram-username">@joy_center →</a></div>
                </div>
            </div>
        </div>
    </div>
